...
public class TightDecoder extends Decoder {
  ...
  /** Not allocated per rect. */
  private static final ThreadLocal<JpegDecompressor> JD =
    new ThreadLocal<JpegDecompressor>() {
      protected JpegDecompressor initialValue() { return new JpegDecompressor(); }
    };
                         ...
                         ModifiablePixelBuffer pb)
  {
    ...
    if (comp_ctl == tightJpeg) {
      ...
      io.github.zirize.vncviewerforgames.perf.PerfStats.INSTANCE.jpegRect();
