...
public abstract class PixelBuffer {
  ...
  // ANDROID PORT: Access to underlying Bitmap
  public android.graphics.Bitmap getAndroidBitmap() { return null; }

  /**
   * Decodes a JPEG rect into this pixel buffer **at the rect's own position**.
   * Overridden by the Android implementation; the default is "cannot do it".
   */
  public boolean decodeJpegRect(byte[] src, int len, Rect r) { return false; }
